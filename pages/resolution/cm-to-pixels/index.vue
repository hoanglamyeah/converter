        ...
        <div class="columns">
            <div class="column is-8">
                ...
                <section class="has-text-left">
                    ...
                    <p> Bellow are pixels to inches conversion table sample with DPI is {{dpi}}</p>
...
<script>
    ...
    export default {
        ...
        methods: {
            convert(dpi, input) {
                return dpi * input / 2.54
            }
        },

        computed: {
            to() {
                return ultil.getFrom(this.type, 'cm-to-pixels')
            },

            from() {
                return ultil.getTo(this.type, 'cm-to-pixels')
            },
