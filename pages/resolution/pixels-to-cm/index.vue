        ...
        <div class="columns">
            <div class="column is-8">
                    ...
                    <div class="wrapper">
                        ...
                        <div class="columns">
                            <div class="column">
                                <b-field>
                                    <p class="control">
                                        <span class="button is-static">Pixels</span>
                                    </p>
                                    <b-input expanded v-model="pixel"></b-input>
                                </b-field>
                            </div>
                            <div class="column">
                                <b-field>
                                    <p class="control">
                                        <span class="button is-static">DPI</span>
                                    </p>
                                    <b-input expanded v-model="dpi"></b-input>
                                </b-field>
                            </div>
                        </div>
                        <h4 class="title is-4 has-text-centered">{{pixel}} pixels is equal {{cm}} centimeters</h4>
                    </div>
                </section>
                <section class="has-text-left">
                    ...
                    <p> Bellow are pixels to centimeter conversion table sample with DPI is {{dpi}}</p>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            cm() {
                return this.convert(this.dpi, this.pixel)
            }
        }
    }
</script>
